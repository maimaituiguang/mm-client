...
export default {
    ...
    'task.list': {
        title: '全部任务',
        url: '/pages/diandian/task/allTasks.js'
    },
    'wallet.reward': {
        title: '提现',
        url: '/pages/diandian/wallet/reward.js'
    },
    'wallet.history': {
        title: '收益明细',
    ...
    'mine.viewTask': {
        title: '任务查看',
        url: '/pages/diandian/mine/viewTask.js'
    },
    'member.members': {
        title: '会员',
        url: '/pages/diandian/member/members.js'
    },
    'mine.settings': {
        title: '设置',
        url: '/pages/diandian/mine/settings.js'
    },
    'member.pay': {
        title: '支付',
